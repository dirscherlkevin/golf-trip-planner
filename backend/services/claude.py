...
{{
  ...
  "website": "Specific hotel property page URL on the chain's website (e.g. https://www.marriott.com/en-us/hotels/mspwe-name/overview/). Use the real URL for this property — do not invent paths.",
